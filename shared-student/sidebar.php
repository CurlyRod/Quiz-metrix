...
<section id="sidebar">
	...
	<ul class="side-menu">
		...
		<li><a class="nav-link" href="#" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addShortcut"><i class='bx bx-plus-circle icon'></i>Add Shortcut</a></li>
