...
<head>
    ...
    <title>Edit Deck - Flashcards</title>
...
<body>
    ...
    <input type="hidden" id="deck-id" value="<?php echo isset($_GET['id']) ? htmlspecialchars($_GET['id']) : ''; ?>">
    ...
    <div class="main-content">
        <div class="deck-creator">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3 class="mb-0">Edit Deck</h3>
                <div>
                    <button class="btn me-2" id="saveDeckBtn" style="background-color: #6366f1; color: white;">Save Changes</button>
                    <button class="btn btn-success" id="saveAndStudyBtn">Study</button>
            ...
            <div class="alert alert-info d-none" id="loadingAlert">
                <i class="bi bi-hourglass-split"></i> Loading deck...
            </div>
            <hr class="solid">
            <!-- Edit Deck Form -->
            ...
            <!-- Flashcard Cards -->
            <div id="flashcardCards">
                <!-- Flashcard cards will be dynamically added here -->
            </div>
            <!-- Add Card Button -->
            ...
            <div class="modal-body">
                <div class="mb-4">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="studyMode" id="sequentialMode" value="sequential" checked>
                        <label class="form-check-label" for="sequentialMode">
                            Sequential (in order)
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="studyMode" id="randomMode" value="random">
                ...
                <div class="mb-3">
                    <h6 class="mb-3">Progress Tracking</h6>
