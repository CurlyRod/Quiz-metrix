...
<body>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="mb-0">Import Flashcards</h2>
                    <div>
                ...
                <div class="mb-4">
                    <p class="text-muted small">Paste your data below. Front - Back;</p>
                    <textarea class="form-control" id="importData" rows="12" placeholder="Front - Back;&#10;Front - Back;&#10;Front - Back;" style="resize: none; height: 600px;"></textarea>
                </div>

                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <h6>Between Front and Back</h6>
    ...
    <script src="js/import-flashcards.js"></script>
</body>
</html>
